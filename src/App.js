...
// --- START: Consolidated MarkdownRenderer Definition ---
const MarkdownRenderer = ({ reportData }) => {
  const renderSkillGapAnalysisSection = () => {
    ...
    return (
      <div className="section">
        <h2 className="text-xl font-semibold mb-4" style={{ color: colors.slateBlue }}>Skill Gap Analysis</h2>
  ...
  const renderActionPlanSection = () => {
    ...
    return (
      <div className="section">
        <h2 className="text-xl font-semibold mb-4" style={{ color: colors.slateBlue }}>Personalized Action Plan</h2>
  ...
  const renderAiReportSection = () => {
    ...
    return (
      <>
        <div className="section">
          <h2 className="text-xl font-semibold mb-4" style={{ color: colors.slateBlue }}>AI Impact Analysis</h2>
          <div dangerouslySetInnerHTML={{ __html: markdownToHtml(aiReportData.aiImpactAnalysis, colors) }} />
        </div>
        <div className="section">
          <h2 className="text-xl font-semibold mb-4" style={{ color: colors.slateBlue }}>Future Scenarios</h2>
          <div dangerouslySetInnerHTML={{ __html: markdownToHtml(aiReportData.futureScenarios, colors) }} />
        </div>
        {aiReportData.actionPlan && renderActionPlanSection()}
      </>
    );
  };
  ...
  const MarkdownRenderer = ({ reportData }) => {
    const renderReportContent = () => {
      ...
      return (
        <>
          {aiReportData && renderAiReportSection()}
          {skillGapData && renderSkillGapAnalysisSection()}
        </>
      );
    };
...
// --- END: Consolidated MarkdownRenderer Definition ---
